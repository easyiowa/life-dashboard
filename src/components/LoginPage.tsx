    ...
    <div className="flex flex-col gap-1.5">
      ...
      <div className="relative">
        <input
          ...
          className={`w-full h-11 px-3.5 rounded-xl bg-white/[0.04] border text-sm text-white placeholder:text-slate-600 outline-none focus:bg-white/[0.06] transition-colors pr-${isPassword ? "10" : "3.5"} ${
...
export default function LoginPage() {
  ...
  async function handleGoogle() {
    ...
    // Google redirects away — loader stays until redirect completes
  }
    ...
    <div className="min-h-screen bg-[#0B0F19] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="flex flex-col items-center gap-3 mb-8">
          <div className="w-14 h-14 rounded-2xl flex items-center justify-center shadow-[0_0_40px_rgba(139,92,246,0.35)]"
