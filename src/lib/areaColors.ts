...
export const AREA_COLORS: Record<string, AreaColorSet> = {
  emerald: {
    ...
    pillActive:   "bg-emerald-500 border-emerald-500 text-white shadow-[0_0_12px_rgba(16,185,129,0.4)]",
  ...
  sky: {
    ...
    pillActive:   "bg-sky-500 border-sky-500 text-white shadow-[0_0_12px_rgba(14,165,233,0.4)]",
  ...
  pink: {
    ...
    pillActive:   "bg-pink-500 border-pink-500 text-white shadow-[0_0_12px_rgba(236,72,153,0.4)]",
  ...
  rose: {
    ...
    pillActive:   "bg-rose-500 border-rose-500 text-white shadow-[0_0_12px_rgba(244,63,94,0.4)]",
  ...
  orange: {
    ...
    pillActive:   "bg-orange-500 border-orange-500 text-white shadow-[0_0_12px_rgba(249,115,22,0.4)]",
  ...
  indigo: {
    ...
    pillActive:   "bg-indigo-500 border-indigo-500 text-white shadow-[0_0_12px_rgba(99,102,241,0.4)]",
